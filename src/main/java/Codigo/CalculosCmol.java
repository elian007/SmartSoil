...
public class CalculosCmol {
        public float S_cmol(float potassio, float magnesio, float calcio){
        ...
        public float CTC_cmol(float potassio, float magnesio, float calcio, float h_al){
        ...
        public float V_atual (float potassio, float magnesio, float calcio, float h_al){
